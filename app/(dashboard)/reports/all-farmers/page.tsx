    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500 text-sm">Balance summary for all registered farmers</p>
        </div>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead className="bg-gray-50 border-b border-t">
                <tr>
                  {["#", "Name", "Village", "Phone", "CNIC", "Total Dr", "Total Cr", "Balance", "Status", ""].map((h) => (
              ...
              {!loading && filtered.length > 0 && (
                <tfoot className="bg-gray-50 border-t-2 border-gray-200">
                  <tr>
                    <td colSpan={5} className="px-4 py-3 font-bold text-gray-700">{filtered.length} farmers</td>
