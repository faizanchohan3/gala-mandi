  ...
  return (
    <div className="space-y-6">
      ...
      <div className="hidden print:block mb-6">
        ...
        <h2 className="text-xl font-bold">Farmer Ledger</h2>
        {ledger?.farmer && (
          <div>
            <p className="text-base font-medium text-gray-700">{ledger.farmer.name}</p>
            {ledger.farmer.village && <p className="text-sm text-gray-500">Village: {ledger.farmer.village}</p>}
            {ledger.farmer.phone && <p className="text-sm text-gray-500">Phone: {ledger.farmer.phone}</p>}
          </div>
        )}
        <p className="text-sm text-gray-600 mt-1">Period: {dateLabel}</p>
      </div>
