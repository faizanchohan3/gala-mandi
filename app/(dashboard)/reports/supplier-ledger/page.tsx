    ...
    <div className="space-y-6">
      ...
      <div className="hidden print:block mb-4">
        ...
        <div style={{padding:"10px 22px 8px",background:"#f8fdf8",borderBottom:"1px solid #e5e7eb"}}>
          <h2 style={{margin:0,fontSize:"16px",fontWeight:800,color:"#14532d"}}>Supplier Ledger</h2>
          {ledger?.supplier && (
            <div style={{marginTop:"6px",fontSize:"13px"}}>
              <span style={{fontWeight:700,color:"#111827"}}>{ledger.supplier.name}</span>
              {ledger.supplier.phone && <span style={{color:"#6b7280",marginLeft:"8px"}}>Ph: {ledger.supplier.phone}</span>}
            </div>
          )}
